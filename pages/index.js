              ...
              >
                <a>
                  <img
                    src={placeholder1}
                    data-src={
                      item.picture.formats.small.url.substr(item.picture.formats.small.url.indexOf("h"),item.picture.formats.small.url.indexOf("ad")+3) + "f_auto/" + item.picture.formats.small.url.substr(item.picture.formats.small.url.indexOf("ad")+3)
                    }
                    width="464"
                    height="430.59"
            ...
            >
              ...
              >
                <a>
                  <img
                    src={placeholder1}
                    data-src={item.picture.formats.small.url.substr(item.picture.formats.small.url.indexOf("h"),item.picture.formats.small.url.indexOf("ad")+3) + "f_auto/" + item.picture.formats.small.url.substr(item.picture.formats.small.url.indexOf("ad")+3)}
                    width="464"
                    height="430.59"
                    alt={item.picture.name}
                    className="object-fill w-75 mx-auto lazyload"
              ...
              {item.picture.slice(-4).map((object) => (
                ...
                >
                  <img
                    ...
                    data-src={object.formats.small.url.substr(object.formats.small.url.indexOf("h"),object.formats.small.url.indexOf("ad")+3) + "f_auto/" + object.formats.small.url.substr(object.formats.small.url.indexOf("ad")+3)}
                    width={object.width}
